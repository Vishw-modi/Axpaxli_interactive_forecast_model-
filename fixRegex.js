...
const regex = /<p className="lead">The base case alongside any custom scenarios you've saved\.<\/p>[\s\S]*?<div className="card">/g;

const replacement = `<p className="lead">The base case alongside any custom scenarios you've saved.</p>
